  ...
  return (
    <Html lang="pt-BR">
      <Head>
        ...
        <meta
          property="og:image"
          content="https://jpedromagalhaes.vercel.app/static/images/banner.png"
        />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="João Pedro Magalhães" />
        <meta
          property="og:description"
          content="Desenvolvedor frontend, UI/UX entusiasta & Gopher"
        />
        <meta
          property="og:title"
          content="João Pedro Magalhães - Desenvolvedor frontend, UI/UX entusiasta & Gopher"
        />
      </Head>
      <body>
        <Main />
